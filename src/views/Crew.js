    ...
    return (
      <div>
        <div className="image-library">
          <Portrait name="Linh Nguyen" img={LinhImg} />
          <Portrait name="Gina Wang" img={GinaImg} />
          <Portrait name="Jen Nguyen" img={JenImg} />
          <Portrait name="Shteen Nguyen" img={ShteenImg} />
        </div>
      </div>
    )
}
    ...
    return (
      <div>
        <div className="image-library groomsmen-portaits">
          <Portrait name="Hsu Ken Ooi" img={HsuKenImg} rotate="true" />
          <Portrait name="Brian Ma" img={BmaImg} />
          <Portrait name="Daniel Ooi" img={DanielImg} />
          <Portrait name="Ben Chao" img={BenImg} rotate="true" />
          <Portrait name="Gildas Cheung" img={GildasImg} />
        </div>
      </div>
    )
}
      ...
      <div className="container">
        <div className="text-left">
            ...
            <div className="groomsmen">
                ...
                <Gang name="Gildas Cheung, Groomsman" description="Do we really know who he is? I mean really?" />
            </div>
        </div>
      </div>
    );
